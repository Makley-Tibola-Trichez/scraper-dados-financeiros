...
class AcaoCols(Enum):
    ...
    DIVIDENDO_ANUAL_2026 = EFEITO_BOLA_DE_NEVE + 1
    DIVIDENDO_ANUAL_2025 = DIVIDENDO_ANUAL_2026 + 1
...
class AcaoCells:
    ...
    def __make_cell(self, col_enum: Enum, value: str | None, force_update: bool = False) -> Cell | None:
    ...
    def dividendo_ano_2026(self, value: str | None, force_update: bool = False) -> Cell | None:
        return self.__make_cell(AcaoCols.DIVIDENDO_ANUAL_2026, value, force_update)

    def dividendo_ano_2025(self, value: str | None, force_update: bool = False) -> Cell | None:
        return self.__make_cell(AcaoCols.DIVIDENDO_ANUAL_2025, value, force_update)

    def dividendo_ano_2024(self, value: str | None, force_update: bool = False) -> Cell | None:
        return self.__make_cell(AcaoCols.DIVIDENDO_ANUAL_2024, value, force_update)

    def dividendo_ano_2023(self, value: str | None, force_update: bool = False) -> Cell | None:
        return self.__make_cell(AcaoCols.DIVIDENDO_ANUAL_2023, value, force_update)

    def dividendo_ano_2022(self, value: str | None, force_update: bool = False) -> Cell | None:
        return self.__make_cell(AcaoCols.DIVIDENDO_ANUAL_2022, value, force_update)

    # def cells_dividendos(self, values: list[str], force_update: bool = False) -> list[Cell]:
    #     start_col = AcaoCols.DIVIDENDO_ANUAL_2025.value
    #     return [
    #         Cell(self.row, start_col + i, value) for i, value in enumerate(values) if force_update or value is not None
    #     ]
